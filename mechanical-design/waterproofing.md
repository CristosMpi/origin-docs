...
The enclosure should be designed to reduce risk from:
...
- condensation;
- wet cables;
- water travelling along supports or fasteners;
- temporary outdoor exposure during deployment and service.
...
The current enclosure architecture has several likely weak points:
...
- lower mounting joints;
- mating surfaces between printed parts;
- any ventilation or pressure-equalisation feature.
...
- recessed sensor placement;
- external overhang or drip lip;
- sloped opening geometry;
- replaceable bezel;
- radar-transparent protective window;
- gasketed cover;
- membrane or thin barrier material;
- drainage below the opening.
...
Geometry should encourage water to:

- shed away from seams;
- run past openings rather than into them;
- leave recessed areas through drainage paths;
- avoid pooling near cable penetrations.
...
If used, documentation should identify:

- sealant type;
- compatible materials;
- cure requirements;
- preparation method;
- areas where it must not be applied;
...
- compression grommet;
- internal drip loop;
- offset entry with drainage below;
- sealed support-to-enclosure interface.
...
- blind inserts rather than open through-holes where possible;
- washers or sealing washers where justified;
- screw recess geometry;
- whether water can follow threads into the enclosure;
- corrosion resistance;
- drainage around external screw heads.
...
- seams;
- thin walls;
- infill-connected cavities;
- screw holes;
- poorly fused surfaces.
...
- initial trapped humidity;
- temperature swings;
- internal heat sources;
- pressure changes;
- desiccant where appropriate;
- breathable membrane vents if justified and validated;
- conformal protection of electronics where appropriate.
...
Drain holes or channels may be appropriate for:

- sensor recesses;
- solar-support cavities;
- decorative outer shells;
- lower mounting interfaces.

Drainage paths must not lead toward electronics or protected cable entries.

## Internal protection

Mechanical environmental protection can be supported by internal design features such as:

- raised PCB mounting above the lowest internal surface;
- drip shields;
- separate wet and dry zones;
- cable entry below sensitive electronics;
- splash barriers;
- replaceable internal covers.
...
Testing can use methods such as:

- absorbent indicator paper;
- internal humidity logging;
- visual inspection;
- removable moisture indicators;
- controlled mass comparison where appropriate.
...
Instead, development documentation can state what has actually been validated, for example:

- survived controlled splash test;
- no visible ingress after defined rain simulation;
- sensor opening remained dry under a specified orientation.
